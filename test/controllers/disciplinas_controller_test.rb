...
class DisciplinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disciplina" do
    assert_difference("Disciplina.count") do
      post disciplinas_url, params: { disciplina: { descricao: @disciplina.descricao, diasemana: @disciplina.diasemana, local: @disciplina.local, titulo: @disciplina.titulo } }
    end
  ...
  test "should update disciplina" do
    patch disciplina_url(@disciplina), params: { disciplina: { descricao: @disciplina.descricao, diasemana: @disciplina.diasemana, local: @disciplina.local, titulo: @disciplina.titulo } }
